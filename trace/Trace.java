 ...
 *
 * @version     @(#) Trace.java 1.3 01/12/03 00:18:00
 * @author Robert Field
 */
public class Trace {
    ...
    VirtualMachine launchTarget(String mainArgs) {
        ListeningConnector connector = findLaunchingConnector();
        Map arguments = connectorArguments(connector, mainArgs);
        try {
            System.out.println("vm args: " + connector.startListening(arguments));
     ...
     */
    ListeningConnector findLaunchingConnector() {
...
//            if (connector.name().equals("com.sun.jdi.CommandLineLaunch")) {
     ...
     */
    Map connectorArguments(ListeningConnector connector, String mainArgs) {
