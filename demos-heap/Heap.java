...
abstract public class Heap extends AbstractCollection {
  protected int size_;
  protected Object[] data;
  protected Comparator comparator;
  
  public Heap() { this(4, null); }
  public Heap(int initialMemoryAllocation) { this(initialMemoryAllocation, null); }
  public Heap(Comparator comparator) { this(4, comparator); }
  public Heap(int initialMemoryAllocation, Comparator comparator) { 
